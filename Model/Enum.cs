...
namespace baseVISION.Tool.Connectors.Zoho.Model
{
    ...
    public enum AccountRating { Acquired,Active,[EnumMember(Value = "Market Failed")]MarketFailed,[EnumMember(Value = "Project Canceled")] ProjectCanceled,Shutdown  }
